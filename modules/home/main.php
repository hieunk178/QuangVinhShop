                    ...
                    <ul class="list-item">
                        ...
                        <li>
                            ...
                            <div class="action clearfix">
                                <a href="?mod=cart&act=add&id=<?php echo $sp['MaSP'] ?>&num=1" title="" class="add-cart fl-left">Thêm giỏ hàng</a>
                    ...
                    <ul class="list-item clearfix">
                        ...
                        <li class="product">
                            ...
                            <div class="product-content">
                                ...
                                <div class="action clearfix">
                                    <a href="?mod=cart&act=add&id=<?php echo $item['MaSP'] ?>&num=1" title="Thêm giỏ hàng" class="add-cart fl-left">Thêm giỏ hàng</a>
