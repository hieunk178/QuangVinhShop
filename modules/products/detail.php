                ...
                <div class="section-detail clearfix">
                    ...
                    <div class="info fl-right">
                        ...
                        <div id="num-order-wp">
                            ...
                            <input type="number" name="num-order" value="1" id="num-order" , class="num-order" data-id="<?php echo $sanpham["MaSP"] ?>">
                            <a title="" id="plus" class="change-num"><i class="fa fa-plus "></i></a>
                        </div>
                        <div class="btn-change">
                            <a href="?mod=cart&act=add&id=<?php echo $sanpham['MaSP'] ?>&num=1" title="Thêm giỏ hàng" class="add-cart">Thêm giỏ hàng</a>
                        </div>
